...
app = FastAPI(title="YouTube Video Data API")

@app.get("/api/youtube/videos")
def get_videos():
    try:
        local_gold_path = GOLD_YOUTUBE.replace("hdfs://namenode:9000/user/hadoop", "/workspace/data")
...
@app.get("/api/youtube/silver")
def get_silver_data():
    try:
        local_silver_path = SILVER_YOUTUBE.replace("hdfs://namenode:9000/user/hadoop", "/workspace/data")
